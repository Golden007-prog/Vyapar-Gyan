...
exports.handlerWithEnvironmentLogic = exports.handlerWithClients = exports.handler = void 0;
 ...
 */
const handlerWithClients = async (event, context) => {
    try {
        const config = await (0, config_1.getConfig)();
...
exports.handlerWithClients = handlerWithClients;
/**
 * Example: Environment-specific behavior
 */
const handlerWithEnvironmentLogic = async (event, context) => {
    const config = await (0, config_1.getConfig)();
...
exports.handlerWithEnvironmentLogic = handlerWithEnvironmentLogic;
/**
